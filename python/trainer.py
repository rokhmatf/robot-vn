...
@register_trainer('dmhouse', max_time_steps=11e5, validation_period=100, validation_episodes=20,  episode_log_interval=10, saving_period=100000, save=True, env_kwargs=dict(
    id='DMHouseCustom-v1',
),
    model_kwargs=dict())
